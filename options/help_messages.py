...
L_HELP = 'Passa um limite para a listagem'
...
LIST_WEBSITES_HELP = 'Lista os websites disponíveis.'
SET_WEBSITE_HELP = 'Seleciona o website que sera utilizado.'
CREATESITE_HELP = 'Cria um diretório com o nome do site e arquivos base.'
